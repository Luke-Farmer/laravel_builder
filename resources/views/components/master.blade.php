                ...
                <div class="row py-5 align-items-center">
                    ...
                    <div class="col-12 col-lg-4 d-flex flex-column align-items-center mb-4 mb-lg-0">
                        <div class="">
                            ...
                            <p class="white mb-0 text-center"<a href="https://instagram.com/{{ Settings::where('setting', '=', 'instagram')->first()->value }}">\u0040{{ Settings::where('setting', '=', 'instagram')->first()->value }}</a></p>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 d-flex flex-column align-items-center mb-4 mb-lg-0">
                        <div class="">
